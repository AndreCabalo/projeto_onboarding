...
class CartServiceTest {
    ...
    void saveSuccess() {
        ...
        Cart savedCart = this.cartService.save(new Cart(cartDto));
    ...
    void findAllSuccessWhenAnyCartIsSaved() {
        CartDto cartDto = new CartDto(1L,null,null,null);
        Cart savedCart = cartService.save(new Cart(cartDto));

        assertThat(cartService.findAll().stream().toList()).size().isGreaterThan(0);
    }
    ...
    void findAllWithZeroCartsSaved() {
        ...
        assertThat(cartService.findAll().stream().toList()).size().isZero();
    }
    ...
    void addItemSuccess() {
        ...
        Item item = itemService.save(new Item(itemDto));

        CartDto cartDto = new CartDto(1L,null,null,null);
        Cart cart = cartService.save(new Cart(cartDto));
